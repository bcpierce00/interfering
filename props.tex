...
\begin{document}
  ...
  \paragraph{Traces}
    ...
    \leo{Point out this is coinductive}
    ...
    \[\frac{\obsT_1 = w \obsT_1' \hspace{.5cm} \obsT_2 = w \obsT_2' \hspace{.5cm} \obsT_1' \lesssim \obsT_2'}
           {\obsT_1 \lesssim \obsT_2}\]
    \leo{Doesn't this case miss the recursive $\obsT_1 \lesssim \obsT_2$ condition?}
    ...
    \leo{Oh, I like this version. Should make things cleaner in the top part of my proofs
      while leaving the hard low-level invariants unaffected.}
  ...
  \section{Observable and Eager Stack Safety}
    ...
    \COQ{safe initialization is implemented differently in each property, since
