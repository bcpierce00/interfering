...
(* ??: Establishing equality between traces seems hard, and this overlaps
the previous two cases.  Maybe try:
   ForallTrace (fun o => o = Tau) OO ->
   ForallTrace (fun o => o = Tau) OO' ->
   ObsTraceEq OO OO'
?
?: That was the other thing I had in mind. I'll see what makes proofs easier.
...
Proof.
  ...
  intros T T' Eq(*; pfold*).
  inv Eq.
  + (* ????: This goal is slightly more involved than it was before. *)
    (* apply paco2_unfold. *)
...
Proof.
  ...
  - destruct a'.
    + destruct (EqOut_tauN O1' o1' Last' w T Eq1) as [n [HTau | [T' HTau]]].
      ...
      * rewrite HTau in *.
        ...
        -- apply ObsEqNow.
           ...
           (* ????: The following two subgoals become slightly different. *)
           ++ inversion Last'; subst; clear Last'.
              (*left.*)
              eapply IHLast; eauto.
           ++ inversion Last'; subst; clear Last'.
    ...
    + apply ObsTraceEqRemoveTau1 in Eq1.
      app_frobber.
      (* ????: Ditto here, applying IH is now a bit more explicit. *)
...
(* ?: I didn't like the non-coinductive nature of this... 
...
Proof.
  ...
  + (* ????: Some base cases like this need a little more work than before. *)
    (* apply paco2_unfold. *)
    (* * auto with paco. *)
