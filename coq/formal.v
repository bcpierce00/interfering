...
(* ??: There is something fishy about this definition.
...
| EagerTestCall :
    forall depth args mp MP vs vs' m' p' OM C vsecall,      
      ...
      (* ?: TODO: Current machine, or HEAD MP? *)
...
(* ??: I thought some of these might be approachable if we change to this
...
(* ??: As things stand, retSP is always initSP.  Is this right? *)
(* ?: The retSP should always be the stack pointer of the callee of the "initial" process. So when recursing in StackSafety the retSP should be the SP of (head Mcallee) I think. *)
(* ??: Does the adjustment below do the trick? *)
...
(* ??: I think this is fine, provided that we allow the callee to
...
at first.)  *)
(* ?: Note that this way the handling of arguments/returns is not
