...
\renewcommand{\leo}[1]{\ifdraft\textcolor{teal}{{[LEO:~#1]}}\fi}
...
\newcommand{\freebox}{\genbox{10px}{blue}{}}
\newcommand{\pubbox}{\genbox{10px}{lightgray}{}}
\newcommand{\objbox}{\genbox{10px}{yellow}{}}
\newcommand{\sealbox}{\genbox{10px}{red}{}}

\newcommand{\leftvariant}{cyan}
\newcommand{\rightvariant}{orange}
