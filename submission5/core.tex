...
the intuition of protecting function activations
(both registers and stack frames)\bcp{Can we delete that parenthetical
remark?  I think it distracts more than it clarifies.}
from each other and
...
question directly, then a paragraph break.}
