...
safety. Our properties go further than previous proposals,
...
tail-call elimination. \fi They are modular by design so that they
can be further extended to other features.
