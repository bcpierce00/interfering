...
\bcp{Throughout, the way we talk about the ``core model'' and its
  ...
  quite weasily.}
\item We validate a tag-based stack-safety enforcement mechanism,
\emph{Lazy Tagging and Clearing}, via property-based random testing,
find that it falls short of ensuring stack safety, and propose and
validate a fix.
\end{itemize}
