...
informally. Then in \cref{sec:props} we will introduce the machine model that we test, and give
its {\em security semantics}, described in brief below.
%In \cref{sec:props} we give abbreviated
%formal statements of the properties, while
The full formalism is found in \cref{app:props}.
...
\MACHS \times \CONTEXTS \rightarrow \MACHS \times \CONTEXTS \times \mathit{list} ~ \Psi \times \OBSS\).
