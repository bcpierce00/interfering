...
This protean nature of the functional abstraction makes stack safety
...
Our motivating enforcement mechanisms,
...
\ifexceptions tail-call elimination, and exceptions.
\else and tail-call elimination. \fi They are modular by
...
other, similar attacks. To avoid this \leo{game of whack-a-mole}, we seek formal properties of safe behavior that can be proven
...
\begin{figure}
  ...
  \begin{subfigure}{\columnwidth}
    ...
    \(\textnormal{\large \dots} \pubbox[30pt] \!\! \stackrel{\textsc{\normalsize sp}}{\textbox[\tt res]}
...
\apt{good place to detail the needed changes in interpretation of \cref{tab:props}.}
...
\apt{Presumably R\&dH don't care about registers because they already have
  the compiler in the TCB.  We should note (perhaps earlier than here!) that
