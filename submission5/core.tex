...
\begin{figure*}
  \begin{tabular}{|r|r||l|r}
    ...
    \multicolumn{2}{l}{} \\
  \end{tabular}
  \caption{Execution of example up through the return from {\tt f}. In stack diagrams, addresses increase to the right, stack grows to the left, and boxes represent 4-byte words. \sna{Reviewer 2 found s0 and a1 confusing, as well as lack of ra a4 and a5. Priority 3.}}
\label{fig:exec1}
\end{figure*}
%
...
purpose: those labeled \(\public\) and \(\object\). \sna{Define state elements before this. Priority 3.}
...
to ensure that our definitions are well-formed \rb{, to reason about them,} and to leverage the
...
\rb{
((Cache pressure discussion relevant?))
...
\sna{Move to section 5, cleanup. Priority 3.}
