...
that support only some aspects of stack safety\bcp{where do we show
  this?}.  The properties they are parameterized over a notion of
...
calls might mean that the property becomes too strong to be
enforced.\bcp{I don't understand that---wouldn't it mean that
  enforcing the property causes almost all programs to be rejected?
  (I.e., isn't it a case of false negatives rather than false
  positives?)}
