...
\paragraph*{Lazy Applicability}

Roessler and DeHon describe {\em Lazy Tagging and Clearing} as aiming to enforce
a fundamentally different property than {\em Depth Isolation}. They consider \(DI\)
a form of memory safety, while they claim that {\em dataflow integrity} enforces a
form of {\em dataflow integrity}. Because our properties are phrased in
terms of dataflow, they represent a plausible definition  against which \(LTC\) can be tested.

\sna{Discuss the distinction that they make between memory safety and
  dataflow integrity; we have framed stack safety as a dataflow integrity
  problem. They did not give a formal specification, and their implementation
  does not enforce ours. Spell out the violation. Priority 1.}
