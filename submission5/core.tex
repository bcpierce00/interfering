...
To characterize confidentiality\apt{and sometimes integrity}, we borrow the idea of \emph{variant} states
...
\apt{Presumably R\&dH don't care about registers because they already have
  the compiler in the TCB.  We should not (perhaps earlier than here!) that
  we have a stronger attacker model since we don't require the callee code
  to come from a trusted  compiler.}
