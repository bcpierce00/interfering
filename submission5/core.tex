...
Indeed, the call stack is a perennial target for low-level attacks \cite{phrack96:smashingthestack}.
%
The CWE Top 25 Most Dangerous Software Weaknesses list
\footnote{\url{https://cwe.mitre.org/top25/archive/2022/2022_cwe_top25.html}}
is consistently topped by classes of vulnerabilities closely related to the stack
e.g., \#1 Out-of-bounds Write, \#5 Out-of-bounds Read, or \#7 Use After Free.
%
And many other types of attack involve compromising the stack as a step in a larger workfloaw
\cite{DBLP:conf/raid/VeendCB12,
...
integrity\cite{Kuznetsov+14}
are stronger, but most do not give formal guarantees.
...
micro-policies for stack safety, at least some of which should be amenable to making strong
formal guarantees. Their most realistic micro-policy, ``Lazy Tagging and Clearing'' (\(LTC\)),
which makes an interesting trade-off for performance: it allows function activations to write
