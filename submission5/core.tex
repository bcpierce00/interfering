...
To characterize this situation in a property, we use the concept of {\it non-interference}
based on variant states. Specifically, we consider two values to be variants, even if their
payload values differ, as long as the remainder of their state respects other system-specific
constraints; in the case of the tagged system, the tag component must be identical.
Then, for a set of elements \(\components\),
...
\definition For a given system, assume an equivalence relation \(\sim\) on values.
