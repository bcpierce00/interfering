...
\sna{Trying to think how to make the case that these CWEs are about the stack, since they are
  primarily described as memory attacks.}\apt{Agree: the out-of-bounds ones are often on the stack, but the NULL pointer deref is not \rb{Indeed, removed the last one.}
Also, this story is very well known, and doesn't need belaboring.}
%
...
\sna{In discussion above, I tried to carve out some separation there, but more may be needed.}
