...
\apt{Add brief description of \ref{subfig:WBCF2}.}
...
\section{Enforcement and Testing}
...
I have a sketch of an argument that we would not gain anything meaningful from confidentiality
of tags, but it still needs some work. Still, I think it's correct not to vary the policy state.
