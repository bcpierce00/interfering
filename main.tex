...
{\em Hyperproperties}, i.e. properties of pairs\leo{sets?} of execution traces,
...
intentionally. \bcp{reword, maybe using ``nested'':}Moreover, this setting
admits a principled treatment of
...
\apt{Um..this seems to conflate visibility (\VIS,\HID) with
  security/privacy level (\HIGH,\LOW).  Don't we want to distinguish these?}
