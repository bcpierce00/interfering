...
\bcp{I'm having some trouble here.  Two main problems so far:
  \begin{itemize}
  \item Since the ``high part'' of the world keeps getting extended as
  ...
  \item Even after adding a separate IFC-like label for ``internal'' cells
  (that are not scrambled but also not outputs), I'm not seeing clearly how
  to formulate taint checking as an NI-like property.  Need to think about
  it some more.
  \end{itemize}
}
