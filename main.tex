...
\bcp{Sketchy / out of date from here on...}
  ...
  \begin{itemize}
  \item I am not sure whether we want to be talking in terms of {\em
    properties} or {\em hyperproperties} here (and all the way through).
  \end{itemize}
  \item Proposal: Forget about full-blown NI and focus the whole paper on
  variants of ``lockstep NI'' where the PC is the same in every pair of
  related runs.
  \begin{itemize}
