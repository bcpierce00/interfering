...
(\contour_1,\mach_1),\ldots$ of (contour, machine state) pairs in which
adjacent machine states are related by $\stepstounderfull$---i.e., in which
$\mach_{i-1} \stepstounderfull \mach_i$ for each $i > 0$ in the sequence.
...
\leo{Low should be VIS here right?}
