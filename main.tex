...
\bcp{Try this:
  \begin{itemize}
  \item two separate axes: high/low and observable/hidden
  \item both part of contours
  \end{itemize}
}
...
A {\em contour}
$\contour \in \CONTOURS = \COMPONENTS \rightarrow \{\HIGH,\LOW\}$ is a
...
$\contour$---i.e., if $\contour(\component) = \LOW$, then $\mach(\component)
= \mach'(\component)$.
...
$\pol{\contour}(\mach_1) = \mach_2$.  \bcp{It should also return a contour!}
