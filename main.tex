...
$\LOWINT$ is freely accessible \apt{``accessible''?} memory. As examples of different
...
\apt{How is this definition of contoured traces connected to the various properties
  below (which seem to talk about an (uncontoured) trace plus a single contour) ?}
