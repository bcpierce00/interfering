...
pairs of a contour and a machine state
...
sequence of the {\em distinct} values taken on by this component at moments
when it is {\em observable}.  Formally, this map can be constructed as
...
\bcp{It gets sketchy from here on!  The observer needs to be simplified as
  above, at a minimum.}

An {\em observer} $\observer \in \exists X.\; (\CONTOURS \rightarrow X) \times
