...
terminate execution early.  \bcp{Swap initial arrow and existential}

\subsection{Properties}

\bcp{Here is where it starts getting iffy...}

\bcp{Another try: An observation trace is generated from a function that
  takes a machine state and a contour and an X and returns the same stuff.
  (This is almost the same as a policy!)}
