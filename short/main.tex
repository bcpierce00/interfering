...
consequences  from leakage or corruption of private stack data to
...
allow ``lazier'' protection mechanism that permit ``dangerous'' reads or
...
notion of noninterference, but where ordinary noninterference is 
an end-to-end hyper-property on whole program runs, stack confidentiality is
a ``nested'' form of 
noninterference applied to
subtraces of the whole program trace, requiring that, between each call
