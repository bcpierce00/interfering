...
its ``return target,''
which holds on the states that would follow a well-behaved return.\apt{I think this
  was better before when the definition of return target was more concrete.}
Whether or not a callee executes a return instruction,
we consider it to be returning only when it reaches a return target.\apt{Reworded
last sentence slightly; seems repetitive in anyc ase.}
So the caller is protected until then, even if the callee is
