...
We formalize integrity and confidentiality as trace (hyper-)properties, in two different
...
end-to-end hyper-property, stack confidentiality is noninterference applied over
