...
\apt{Here's another stab:}
Our attacker model is very strong, allowing the attacker to execute arbitrary code.
In particular, we do not attempt to prevent \apt{most forms of?} control-flow attacks
\apt{such as ROP?}. The notions of integrity and confidentiality remain useful even
in the absence of normal control flow.
