...
\bcp{I tried rewriting the first part of the paragraph, and I like it
  ...
  about all this.}
\sna{Better transition.}
The question then arises: when are suspended frames reactivated, or equivalently,
what constitutes a return in this setting? We define returns according to the behavior
we would expect in a more structured environment.
Every call has a corresponding predicate on states,
its ``return target,''
